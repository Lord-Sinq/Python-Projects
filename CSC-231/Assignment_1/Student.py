...
def main():
    ...
    '''
    students = []
    with open('/Users/sinq/PycharmProjects/pythonProject/CSC-231/Assignment_1/listOfNames_short.txt','r') as file:
        for line in file:
            line = line.strip()
            ID, name = line.split('\t')
            ID = int(ID)
    ...
    with open('/Users/sinq/PycharmProjects/pythonProject/CSC-231/Assignment_1/searchIds_short.txt','r') as file:
            for line in file:
                line = line.strip()
                ID = int(line)
